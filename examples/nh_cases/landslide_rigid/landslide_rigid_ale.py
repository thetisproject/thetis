...
n_layers = 3
outputdir = 'outputs_landslide_rigid_ale'
...
# --- create solver ---
solver_obj = nhsolver_ale.FlowSolver(mesh2d, bathymetry_2d, n_layers)
...
def update_forcings(t):
    landslide_source = solver_obj.fields.get('slide_source_2d')
    hs = (slide_shape(t + options.timestep) - slide_shape(t))/(options.timestep)
    landslide_source.project(hs)
    solver_obj.bathymetry_dg.project(solver_obj.fields.bathymetry_2d - slide_shape(t + options.timestep))
