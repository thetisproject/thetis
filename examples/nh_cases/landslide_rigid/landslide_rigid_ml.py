...
n_layers = 3
outputdir = 'outputs_landslide_rigid_ml'
...
# --- create solver ---
solver_obj = nhsolver_ml.FlowSolver(mesh2d, bathymetry_2d)
...
# limiter
options.use_limiter_for_elevation = not True
options.use_limiter_for_multi_layer = not True
# landslide
