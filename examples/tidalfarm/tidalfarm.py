...
options.dt = tidal_period/50
options.t_export = 0.9 * options.dt
options.t_end = 0.5*tidal_period
...
solver_obj.options.shallow_water_theta = 0.6
options.h_viscosity = Constant(60.)
