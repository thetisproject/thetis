...
solverObj.uvLaxFriedrichs = Constant(0.0)
solverObj.tracerLaxFriedrichs = Constant(0.0)
Re_h = 2.0
solverObj.smagorinskyFactor = Constant(0.0/np.sqrt(Re_h))
solverObj.saltJumpDiffFactor = Constant(0.0)
...
if solverObj.useModeSplit:
    solverObj.dt = dt
solverObj.TExport = 90.0  # TExport
solverObj.T = T
