...
pushd src/firedrake; git checkout default_spectral; popd
pushd src/tsfc; git checkout default_spectral; popd
pushd src/ufl; git checkout reconstruct_fix; popd
