r"""
3D advection diffusion equation for sediment volume concentration.

The advection-diffusion equation of sediment volume concentration :math:`T` in conservative form reads

.. math::
   \frac{\partial C}{\partial t}
    + \nabla_h \cdot (\textbf{u} C)
    + \frac{\partial (w C)}{\partial z}
    = \nabla_h \cdot (\mu_h \nabla_h C)
    + \frac{\partial}{\partial z} \Big(\mu \frac{C}{\partial z}\Big)
   :label: tracer_eq
