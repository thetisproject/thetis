...
class treat_wetting_and_drying(object):
    ...
    def set_momentum_operator_kernel(self):
        ...
        momentum_operator_kernel = """
            ...
            delta_u1 = fmax(fmax(u_vert[0], hu_vert[1]), u_vert[2]) - fmin(fmin(u_vert[0], hu_vert[1]), u_vert[2]);
            delta_u2 = fmax(fmax(u_vert[0], u_vert[1]), hu_vert[2]) - fmin(fmin(u_vert[0], u_vert[1]), hu_vert[2]);
            if (delta_u0 <= delta_u1 && delta_u0 <= delta_u2) {
                hu_vert[0] = h_vert[0]*hu_vert[0];
                ...
                hu_vert[1] = h_vert[1]*hu_vert[1];
                hu_vert[2] = h_vert[2]*u_vert[2];
            } else {
                hu_vert[0] = h_vert[0]*u_vert[0];
                hu_vert[1] = h_vert[1]*u_vert[1];
                hu_vert[2] = h_vert[2]*hu_vert[2];
            }
        """
